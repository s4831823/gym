function init() {
    ...
    var AMOUNTY = 100;
    var SEPARATION = 10;
    var renderer, scene, camera, pointLight, particleSystem, count = 0;
    ...
    scene.fog = new THREE.Fog( _params.fogColor, _params.fogMin, _params.fogMax);

    //

    camera = new THREE.PerspectiveCamera(45, window.innerWidth/window.innerHeight, 0.1, 4700);
    ...
    particleSystem.position.set(camera.position.x, camera.position.y -40 , camera.position.z)
